...
export const productDataTwo =[
    {
      ...
      alt:'Donuts',
      name:'Doughlicious',
    desc:'Belgian choclate glazed donuts covered in icing with sprinkles ontop',
    price:'$9.99',
    button:'Add to Cart'
    },
    {
        ...
        alt:'Ice Cream',
        name:'Caramel Monder',
      desc:'Vanilla ice cream covered with caramel and chocolate glaze topped acoco stick',
      price:'$12.99',
      button:'Add to Cart'
      },
      {
